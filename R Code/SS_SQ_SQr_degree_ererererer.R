...
path <- "D:/SS4MLN/ererererer/"
#path <- "D:/SS4MLN/ererererer/"


#full/compleete network
fullnet <- read_ml("d:/SS4MLN/FullNet/erererererNoLoops.mpx", name="ererererer", sep=',', aligned=FALSE)
#fullnet <- read_ml("d:/SS4MLN/FullNet/erererererTransportation_multiplex_4NoNature.edges", name="ererererer", sep=',', aligned=FALSE)
...
#single stage seeding
  ...
  #results <- data.frame(network_name=factor(), network=factor(), pp=numeric(), network_id=numeric(), seed_count=numeric(), no_of_seeds=numeric(), no_of_activated=numeric(), no_of_iterations=numeric())
    ...
    save_path <- "D:/SS4MLN/Results/results_ererererer_degree_ss.txt"
...
for (seed_count in seed_count_v) {
  ...
  save_path <- "D:/SS4MLN/Results/results_ererererer_degree_sq.txt"
...
for (seed_count in seed_count_v) {
  ...
  save_path <- "D:/SS4MLN/Results/results_ererererer_degree_sqr.txt"
